...
MATH_POSITIONS = {
    '/': {'col': 3, 'row': 2, 'character': '/', 'image path': {'light': 'images/divide_light.png', 'dark': None}},
...
OPERATORS = {
    ...
    'invert': {'col': 1, 'row': 2, 'text': '', 'image path': {'light': "logo_gpt.ico", 'dark': "logo_gpt.ico"}},

# 'invert': {'col': 1, 'row': 2, 'text': '', 'image path': {'light': 'images/invert_light.png', 'dark': 'images/invert_dark.png'}}, #original line
